...
const extractFavorites = (
  ...
  if (payload?.favoriteTeachers) {
    return normalizeFavorites(payload.favoriteTeachers);
  }
  ...
  if (user?.favoriteTeachers) {
    return normalizeFavorites(user.favoriteTeachers);
  }
      ...
      if (refreshResponse?.user) {
        get().setUser({
          ...
          favorites:
            ...
            refreshResponse.user.favoriteTeachers ??
            refreshResponse.favoriteTeachers,
        });
        return;
      }
      ...
      if (meResponse?.user) {
        ...
        const userWithServerData = {
          ...
          favorites:
            ...
            meResponse.user.favoriteTeachers ??
            meResponse.favoriteTeachers,
        };
